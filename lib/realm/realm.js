...
import { COMPLETION_EXPIRED_ERROR, COMPLETION_HISTORY_GLOBAL, HIDDEN_BINDING_MEMBER, LAST_RESULT_GLOBAL, MIN_OUTPUT_BYTES, OutputLedger, resolveCompletionHistoryLimits, resolveCompletionProjectionLimits, } from './protocol.js';
...
function parseRunMetrics(raw) {
    ...
    const source = raw;
    const metrics = {};
    for (const key of ['captureBytes', 'captureNodes', 'evicted', 'expired', 'refused', 'historyEntries', 'historyBytes']) {
