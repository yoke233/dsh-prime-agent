...
function parsedDiffs(parsed) {
    const diffs = [];
    for (const file of parsed.files) {
        if (file.operation === 'delete' || (file.operation === 'update' && file.movePath !== null))
            return undefined;
...
function metaDiffs(meta) {
    if (typeof meta !== 'object' || meta === null || Array.isArray(meta) || !Array.isArray(meta.diffs))
        return undefined;
    const diffs = [];
