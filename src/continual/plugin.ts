...
- Do not use this tool for task data, research notes, intermediate results, or large context; those belong in the live namespace and durable task files.
...
export function registerContinual(ctx: Context, config: ContinualConfig): HarnessStore {
  ...
  ctx.tools.register(defineTool({
    name: toolName,
    description: 'Inspect, refine, or conflict-safely roll back stable Prime learning rules. Never store task context or intermediate results here; those belong in the live namespace and durable task files.',
    parameters: {
