 ...
 * `ptc-runtime` row, and its whole job is composition — monitor its owning
 * parent, place the packaged Prime preset, and mount the trusted
 * `primeRealmRuntime` service. The official `ctx.ptcRuntime` is left to
 ...
 * `primeRealmRuntime` service. The official `ptcRuntime` provider is
